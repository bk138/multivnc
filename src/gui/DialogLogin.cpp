...
: wxDialog(parent, id, title, wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER) 
{
    ...
    m_usernameLabel = new wxStaticText(this, wxID_ANY, _("Username: "), wxDefaultPosition, wxSize(70, -1));
    ...
    m_passwordLabel = new wxStaticText(this, wxID_ANY, _("Password: "), wxDefaultPosition, wxSize(70, -1));
