    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE)
{
    ...
    sizer_tightsettings_staticbox = new wxStaticBox(notebook_settings_pane_conn, -1, _("TightVNC Settings"));
    label_compresslevel = new wxStaticText(notebook_settings_pane_conn, wxID_ANY, _("Compression level for \"Tight\" and \"Zlib\" encodings:"));
...
void DialogSettings::do_layout()
{
    ...
    sizer_conn->Add(sizer_tightsettings, 0, wxALL|wxEXPAND, 3);
