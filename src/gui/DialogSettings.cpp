    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE)
{
    ...
    checkbox_fastrequest = new wxCheckBox(sizer_fastrequest->GetStaticBox(), wxID_ANY, _("Enable FastRequest"));
    sizer_fastrequest->Add(checkbox_fastrequest, 0, wxALL|wxEXPAND, 3);
    label_fastrequest = new wxStaticText(sizer_fastrequest->GetStaticBox(), wxID_ANY, _("Continously request updates at the specified milisecond interval:"));
    sizer_fastrequest->Add(label_fastrequest, 0, wxALL, 3);
    slider_fastrequest = new wxSlider(sizer_fastrequest->GetStaticBox(), wxID_ANY, 1, 1, 100, wxDefaultPosition, wxDefaultSize, wxSL_AUTOTICKS|wxSL_HORIZONTAL|wxSL_LABELS);
    ...
    checkbox_qos_ef = new wxCheckBox(sizer_qos->GetStaticBox(), wxID_ANY, _("Enable Expedited Forwarding tagging for sent data"));
    ...
    checkbox_multicast = new wxCheckBox(sizer_multicast->GetStaticBox(), wxID_ANY, _("Enable MulticastVNC"));
    sizer_multicast->Add(checkbox_multicast, 0, wxALL|wxEXPAND, 3);
    label_socketrecvbuf = new wxStaticText(sizer_multicast->GetStaticBox(), wxID_ANY, _("Socket Receive Buffer Size (kB):"));
    sizer_multicast->Add(label_socketrecvbuf, 0, wxALL, 3);
    slider_socketrecvbuf = new wxSlider(sizer_multicast->GetStaticBox(), wxID_ANY, 65, 65, 9750, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL|wxSL_LABELS);
    ...
    label_recvbuf = new wxStaticText(sizer_multicast->GetStaticBox(), wxID_ANY, _("Receive Buffer Size (kB):"));
    sizer_multicast->Add(label_recvbuf, 0, wxALL, 3);
    slider_recvbuf = new wxSlider(sizer_multicast->GetStaticBox(), wxID_ANY, 65, 65, 9750, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL|wxSL_LABELS);
    ...
    checkbox_enc_copyrect = new wxCheckBox(sizer_encbox->GetStaticBox(), wxID_ANY, _("CopyRect"));
    grid_sizer_encodings->Add(checkbox_enc_copyrect, 0, wxALL, 3);
    checkbox_enc_hextile = new wxCheckBox(sizer_encbox->GetStaticBox(), wxID_ANY, _("Hextile"));
    grid_sizer_encodings->Add(checkbox_enc_hextile, 0, wxALL, 3);
    checkbox_enc_rre = new wxCheckBox(sizer_encbox->GetStaticBox(), wxID_ANY, _("RRE"));
    grid_sizer_encodings->Add(checkbox_enc_rre, 0, wxALL, 3);
    checkbox_enc_corre = new wxCheckBox(sizer_encbox->GetStaticBox(), wxID_ANY, _("CoRRE"));
    grid_sizer_encodings->Add(checkbox_enc_corre, 0, wxALL, 3);
    checkbox_enc_zlib = new wxCheckBox(sizer_encbox->GetStaticBox(), wxID_ANY, _("Zlib"));
    grid_sizer_encodings->Add(checkbox_enc_zlib, 0, wxALL, 3);
    checkbox_enc_zlibhex = new wxCheckBox(sizer_encbox->GetStaticBox(), wxID_ANY, _("ZlibHex"));
    grid_sizer_encodings->Add(checkbox_enc_zlibhex, 0, wxALL, 3);
    checkbox_enc_zrle = new wxCheckBox(sizer_encbox->GetStaticBox(), wxID_ANY, _("ZRLE"));
    grid_sizer_encodings->Add(checkbox_enc_zrle, 0, wxALL, 3);
    checkbox_enc_zywrle = new wxCheckBox(sizer_encbox->GetStaticBox(), wxID_ANY, _("ZYWRLE"));
    grid_sizer_encodings->Add(checkbox_enc_zywrle, 0, wxALL, 3);
    checkbox_enc_ultra = new wxCheckBox(sizer_encbox->GetStaticBox(), wxID_ANY, _("Ultra"));
    grid_sizer_encodings->Add(checkbox_enc_ultra, 0, wxALL, 3);
    checkbox_enc_tight = new wxCheckBox(sizer_encbox->GetStaticBox(), wxID_ANY, _("Tight"));
    ...
    label_compresslevel = new wxStaticText(sizer_tightsettings->GetStaticBox(), wxID_ANY, _("Compression level for 'Tight' and 'Zlib' encodings:"));
    sizer_tightsettings->Add(label_compresslevel, 0, wxALL, 3);
    slider_compresslevel = new wxSlider(sizer_tightsettings->GetStaticBox(), wxID_ANY, 0, 0, 9, wxDefaultPosition, wxDefaultSize, wxSL_AUTOTICKS|wxSL_HORIZONTAL|wxSL_LABELS);
    ...
    label_quality = new wxStaticText(sizer_tightsettings->GetStaticBox(), wxID_ANY, _("Quality level for 'Tight' and 'ZYWRLE' encoding:"));
    sizer_tightsettings->Add(label_quality, 0, wxALL, 3);
    slider_quality = new wxSlider(sizer_tightsettings->GetStaticBox(), wxID_ANY, 0, 0, 9, wxDefaultPosition, wxDefaultSize, wxSL_AUTOTICKS|wxSL_HORIZONTAL|wxSL_LABELS);
