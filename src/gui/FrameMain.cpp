    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    wxglade_tmp_menu->Append(wxID_PREFERENCES, _("Preferences"), _("Change preferences."));
    ...
    wxglade_tmp_menu->AppendSeparator();
    wxglade_tmp_menu->Append(ID_LAYOUT_TILE, _("Tile all connections"), _("Arrange all open connections in a tiled layout"));
    Bind(wxEVT_MENU, &FrameMain::view_layout, this, ID_LAYOUT_TILE);
    wxglade_tmp_menu->Append(ID_LAYOUT_UNTILE, _("Untile all connections"), _("Collapse all connections back into a single tab strip"));
    Bind(wxEVT_MENU, &FrameMain::view_layout, this, ID_LAYOUT_UNTILE);
    wxglade_tmp_menu->AppendSeparator();
    ...
    frame_main_toolbar = new wxToolBar(this, -1, wxDefaultPosition, wxDefaultSize, wxTB_HORIZONTAL|wxTB_TEXT);
    ...
    Bind(wxEVT_MENU, &FrameMain::machine_screenshot, this, wxID_SAVE);
    frame_main_toolbar->AddSeparator();
    frame_main_toolbar->AddTool(ID_INPUT_MULTISYNC, _("Multi-Sync Input"), bitmapBundleFromSVGResource(wxString(wxSystemSettings::GetAppearance().IsDark() ? "dark" : "light") + "/" + "multisync"), wxNullBitmap, wxITEM_CHECK, _("Replicate mouse and keyboard input to all connections."), wxEmptyString);
    Bind(wxEVT_MENU, &FrameMain::machine_multisync, this, ID_INPUT_MULTISYNC);
    ...
    list_box_services = new wxListBox(sizer_services->GetStaticBox(), ID_LISTBOX_SERVICES, wxDefaultPosition, wxDefaultSize, 0, list_box_services_choices, wxLB_HSCROLL|wxLB_NEEDED_SB|wxLB_SINGLE);
    ...
    notebook_connections = new wxAuiNotebook(splitwin_main_pane_2, wxID_ANY);
...
void FrameMain::view_layout(wxCommandEvent &event)  // wxGlade: FrameMain.<event_handler>
{
    event.Skip();
    // notify the user that he hasn't implemented the event handler yet
    wxLogDebug(wxT("Event handler (FrameMain::view_layout) not implemented yet"));
}
