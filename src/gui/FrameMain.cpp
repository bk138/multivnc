// -*- C++ -*-
//
// generated by wxGlade 1.0.1 on Mon May  1 12:38:10 2023
//
    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    wxglade_tmp_menu->Append(wxID_ANY, _("Edge Connector"), wxglade_tmp_menu_sub, wxEmptyString);
    wxglade_tmp_menu->AppendSeparator();
    ...
    frame_main_statusbar = CreateStatusBar(2);
    ...
    frame_main_toolbar = new wxToolBar(this, -1, wxDefaultPosition, wxDefaultSize, wxTB_HORIZONTAL|wxTB_TEXT|wxTB_NODIVIDER|wxTB_3DBUTTONS);
    ...
    const wxString list_box_bookmarks_choices[] = {};
