// -*- C++ -*-
//
// generated by wxGlade 1.0.4 on Thu May 25 22:38:33 2023
//
    ...
    wxFrame(parent, id, title, pos, size, wxDEFAULT_FRAME_STYLE)
{
    ...
    wxglade_tmp_menu->Append(wxID_YES, _("&Connect..."), _("Connect to a specific host."));
    ...
    frame_main_toolbar->AddTool(wxID_YES, _("Connect"), bitmapFromMem(connect_png), wxNullBitmap, wxITEM_NORMAL, _("Connect to a specific host."), wxEmptyString);
    Bind(wxEVT_MENU, &FrameMain::machine_connect, this, wxID_YES);
    frame_main_toolbar->AddTool(wxID_REDO, _("Listen"), bitmapFromMem(listen_png), wxNullBitmap, wxITEM_NORMAL, _("Listen for an incoming connection."), wxEmptyString);
    Bind(wxEVT_MENU, &FrameMain::machine_listen, this, wxID_REDO);
    frame_main_toolbar->AddSeparator();
    frame_main_toolbar->AddTool(wxID_STOP, _("Disconnect"), bitmapFromMem(disconnect_png), wxNullBitmap, wxITEM_NORMAL, _("Terminate connection."), wxEmptyString);
    Bind(wxEVT_MENU, &FrameMain::machine_disconnect, this, wxID_STOP);
    frame_main_toolbar->AddTool(ID_GRABKEYBOARD, _("Grab Keyboard"), bitmapFromMem(toggle_keyboard_grab_png), wxNullBitmap, wxITEM_CHECK, _("Intercept all keyboard input. Allows you to use special keys that would otherwise be interpreted by the local computer."), wxEmptyString);
    Bind(wxEVT_MENU, &FrameMain::machine_grabkeyboard, this, ID_GRABKEYBOARD);
    frame_main_toolbar->AddTool(wxID_SAVE, _("Take Screenshot"), bitmapFromMem(screenshot_png), wxNullBitmap, wxITEM_NORMAL, _("Take a screenshot of the current connection."), wxEmptyString);
    Bind(wxEVT_MENU, &FrameMain::machine_screenshot, this, wxID_SAVE);
    frame_main_toolbar->AddSeparator();
    frame_main_toolbar->AddTool(ID_INPUT_RECORD, _("Record Input"), bitmapFromMem(record_png), wxNullBitmap, wxITEM_NORMAL, _("Record mouse and keyboard input for later replay as a macro."), wxEmptyString);
    Bind(wxEVT_MENU, &FrameMain::machine_input_record, this, ID_INPUT_RECORD);
