...
class ZoomScaling extends AbstractScaling {
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractScaling#zoomIn(dontmind.sw.android.MultiVNC.VncCanvasActivity)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractScaling#getScale()
	 */
	@Override
	float getScale() {
		return scaling;
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractScaling#zoomOut(dontmind.sw.android.MultiVNC.VncCanvasActivity)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractScaling#adjust(dontmind.sw.android.MultiVNC.VncCanvasActivity, float, float, float)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractScaling#setScaleTypeForActivity(dontmind.sw.android.MultiVNC.VncCanvasActivity)
	 */
	@Override
