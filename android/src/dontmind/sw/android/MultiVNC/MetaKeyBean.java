...
class MetaKeyBean extends AbstractMetaKeyBean implements Comparable<MetaKeyBean> {
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractMetaKeyBean#getKeyDesc()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractMetaKeyBean#setKeyDesc(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractMetaKeyBean#setKeySym(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractMetaKeyBean#setMetaFlags(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractMetaKeyBean#setMouseButtons(int)
	 */
	@Override
