...
class FullBufferBitmapData extends AbstractBitmapData {
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractBitmapData#copyRect(android.graphics.Rect, android.graphics.Rect, android.graphics.Paint)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractBitmapData#createDrawable()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractBitmapData#drawRect(int, int, int, int, android.graphics.Paint)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractBitmapData#offset(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractBitmapData#scrollChanged(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractBitmapData#syncScroll()
	 */
	@Override
	void syncScroll() {
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractBitmapData#updateBitmap(int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractBitmapData#validDraw(int, int, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see dontmind.sw.android.MultiVNC.AbstractBitmapData#writeFullUpdateRequest(boolean)
	 */
	@Override
